...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,TopName,Photo,Type,Color,Style,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,TopName,Photo,Type,Color,Style,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
